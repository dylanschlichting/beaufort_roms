...
hycom_temp_all = xr.open_dataset('/pscratch/sd/b/bundzis/External_data/HYCOM_data/bryclm_data/Temp/hycom_temp_2019_2024_daily_nogap.nc')
...
# OG grid with 20 vertical layers 
#vert_temp_clm = '/pscratch/sd/b/bundzis/Beaufort_ROMS_2020_dvd_myroms_ice_scratch/Forcing_files/Bryclm/Attempt001/temp_clm_2019_2024_20vert_001.nc'   #UPDATE PATH
# New grid with 30 vertical layers 
vert_temp_clm = '/pscratch/sd/b/bundzis/Beaufort_ROMS_2020_dvd_myroms_ice_scratch/Forcing_files/Bryclm/Attempt001/temp_clm_2019_2024_30vert_001.nc'   #UPDATE PATH
...
#name of file I am writing to
# OG grid with 20 vertical layers
#vert_temp_bry = '/pscratch/sd/b/bundzis/Beaufort_ROMS_2020_dvd_myroms_ice_scratch/Forcing_files/Bryclm/Attempt001/temp_bry_2019_2024_20vert_001.nc'  #UPDATE PATH
# New grid with 30 vertical layers
vert_temp_bry = '/pscratch/sd/b/bundzis/Beaufort_ROMS_2020_dvd_myroms_ice_scratch/Forcing_files/Bryclm/Attempt001/temp_bry_2019_2024_30vert_001.nc'  #UPDATE PATH
...
#     input_field = dr_out_hycom2rho_temp_nonan[tt, :, :, :]
...
#     # In-memory array
#     temp_roms[tt, :, :, :] = full_field

#     # Climatology NetCDF
#     temp_interp_g[tt, :, :, :] = full_field

#     # Boundary NetCDFs
#     temp_west_g[tt, :, :] = west_slice
#     temp_north_g[tt, :, :] = north_slice
#     temp_east_g[tt, :, :] = east_slice
