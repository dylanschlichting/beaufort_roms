...
# OG grid with 20 vertical layers
#vert_v_currents_clm = '/pscratch/sd/b/bundzis/Beaufort_ROMS_2020_dvd_myroms_ice_scratch/Forcing_files/Bryclm/Attempt001/v_currents_clm_2019_2024_20vert_001.nc'  #UPDATE PATH
# New grid with 30 vertical layers
vert_v_currents_clm = '/pscratch/sd/b/bundzis/Beaufort_ROMS_2020_dvd_myroms_ice_scratch/Forcing_files/Bryclm/Attempt001/v_currents_clm_2019_2024_30vert_001.nc'  #UPDATE PATH
...
#name of file I am writing to
# OG grid with 20 vertical layers
#vert_v_currents_bry = '/pscratch/sd/b/bundzis/Beaufort_ROMS_2020_dvd_myroms_ice_scratch/Forcing_files/Bryclm/Attempt001/v_currents_bry_2019_2024_20vert_001.nc'  #UPDATE PATH
# New grid with 30 vertical layers
vert_v_currents_bry = '/pscratch/sd/b/bundzis/Beaufort_ROMS_2020_dvd_myroms_ice_scratch/Forcing_files/Bryclm/Attempt001/v_currents_bry_2019_2024_30vert_001.nc'  #UPDATE PATH
...
#     input_field = dr_out_hycom2v_v_nonan[tt, :, :, :]
#     rho2v_h = dr_out_rho2v_h[:, :]
#     rho2v_zrho = dr_out_rho2v_zrho_flip[tt, :, :, :]
...
#     # Multiply by the mask one more time before saving
#     masked = np.empty((N, eta_v_len, xi_v_len))
#     mask = ds_out_v.mask.values
#     for kk in range(N):
...
#     # In-memory array
#     v_roms[tt, :, :, :] = full_field

#     # Climatology NetCDF
#     v_interp_g[tt, :, :, :] = full_field

#     # Boundary NetCDFs
#     v_west_g[tt, :, :] = west_slice
#     v_north_g[tt, :, :] = north_slice
#     v_east_g[tt, :, :] = east_slice
